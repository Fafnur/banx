...
import { REGISTRATION_FORM_FEATURE_KEY, registrationFormInitialState, RegistrationFormState } from './registration-form.reducer';

describe('RegistrationFormEffects', () => {
  let setStore: (params: Partial<RegistrationFormState>) => void;
    ...
    waitForAsync(() => {
      void TestBed.configureTestingModule({
        ...
        providers: [
          ...
          provideMockStore({
            initialState: {
              [REGISTRATION_FORM_FEATURE_KEY]: registrationFormInitialState,
  ...
  beforeEach(() => {
    ...
    setStore = createSetMockStore(store, REGISTRATION_FORM_FEATURE_KEY, registrationFormInitialState);
  });
  ...
  describe('loadForm$', () => {
    ...
    it('should return loadFormFailure', () => {
      const action = RegistrationFormActions.loadForm();
      const completion = RegistrationFormActions.loadFormFailure({ payload: API_ERROR_RESPONSE_STUB });
  ...
  describe('createForm$', () => {
    ...
    it('should return createFormFailure', () => {
      const action = RegistrationFormActions.createForm({ payload: REGISTRATION_FORM_STUB });
      const completion = RegistrationFormActions.createFormFailure({ payload: API_ERROR_RESPONSE_STUB });
  ...
  describe('validateForm$', () => {
    it('should return validateFormSuccess', () => {
      ...
      when(registrationFormApiServiceMock.validate(PROCESS_ID_STUB, deepEqual({ form: REGISTRATION_FORM_STUB }))).thenReturn(response);
    ...
    it('should return validateFormFailure', () => {
      const action = RegistrationFormActions.validateForm({ payload: REGISTRATION_FORM_STUB });
      const completion = RegistrationFormActions.validateFormFailure({ payload: API_ERROR_RESPONSE_STUB });
  ...
  describe('validateFormField$', () => {
    ...
    it('should return validateFormFieldFailure', () => {
      ...
      const completion = RegistrationFormActions.validateFormFieldFailure({
        payload: { ...API_ERROR_RESPONSE_STUB, field: REGISTRATION_FORM_FIELD_VALIDATE_STUB.field },
      });
  ...
  describe('updateForm$', () => {
    it('should return save form', () => {
      actions = hot('-a-|', { a: RegistrationFormActions.updateForm({ payload: {} }) });
      const expected = hot('---|');
      setStore({ form: REGISTRATION_FORM_STUB });
