...
import { RegistrationCityComponentPo } from './registration-city.component.po';
...
describe('RegistrationCityComponent', () => {
  let pageObject: RegistrationCityComponentPo;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [RegistrationCityComponent, WrapperComponent],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(WrapperComponent);
    pageObject = new RegistrationCityComponentPo(fixture);
  });
