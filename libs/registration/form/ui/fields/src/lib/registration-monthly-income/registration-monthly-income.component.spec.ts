...
import { RegistrationMonthlyIncomeComponentPo } from './registration-monthly-income.component.po';

@Component({
  template: `<banx-registration-monthly-income automation-id="form" [control]="control"></banx-registration-monthly-income>`,
})
...
describe('RegistrationMonthlyIncomeComponent', () => {
  let pageObject: RegistrationMonthlyIncomeComponentPo;
  ...
  beforeEach(() => {
    ...
    pageObject = new RegistrationMonthlyIncomeComponentPo(fixture);
  });
  ...
  it('should show', () => {
    ...
    expect(pageObject.idText).toBe('MonthlyIncome');
    expect(pageObject.labelText).toBe('Monthly income');
